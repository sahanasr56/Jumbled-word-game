...
const selectWord = () => {
    const wordsList = ["hello", "welcome", "great", "happy", "projects", "winner", "difficult", "dangerous", "curious", "knowledge", "science", "seven", "weekends", "damaging", "repository", "explore", "objects", "completed", "wikipedia", "gorgeous"];
